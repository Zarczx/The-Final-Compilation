...
public class Staff extends Weapon {
    ...
    public static final WeaponDef MYSTIC_MIND_STAFF  = new WeaponDef(WeaponType.STAFF, "Mystic Mind Staff",  "🔵", 15, 0,  0, 0, 0, 0, 30, 0, 0);
    public static final WeaponDef FLAMEHEART_STAFF   = new WeaponDef(WeaponType.STAFF, "Flameheart Staff",   "🔵", 15, 3,  0, 0, 0, 0, 0,  0, 0);
    public static final WeaponDef AETHERIC_STAFF     = new WeaponDef(WeaponType.STAFF, "Aetheric Staff",     "🟣", 30, 10, 0, 0, 0, 0, 25, 0, 0);
    public static final WeaponDef CHRONOMANCER_STAFF = new WeaponDef(WeaponType.STAFF, "Chronomancer Staff", "🟡", 50, 10, 0, 0, 0, 0, 35, 0, 0);
