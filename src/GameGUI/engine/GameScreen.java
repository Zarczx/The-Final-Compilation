...
public class GameScreen extends JPanel {
    ...
    public void debugSkipToShop(HeroDefinition hero) {
        ...
        // Create a live combatant and give them money to test the shop
    ...
    private void goToBattle() {
        ...
        // 1. Handle the story dialogues between fights
        ...
        // 2. Load the correct enemies and set what happens when the world is cleared
        if (currentWorld == 1) {
    ...
    private JPanel buildWorld3IntroScreen() {
        ...
        wrapper.setBackground(new Color(30, 10, 10)); // Dark red for world 3
        wrapper.setLayout(null);
        wrapper.setPreferredSize(new Dimension(1280, 720));
        ...
        try {
            java.net.URL darkUrl = getClass().getResource("/assets/Backgrounds/NGEBeforeLights6.png");
            // Optional: If you don't have World3Background.png, this will gracefully fallback to the dark red background
